...
## Core
[Core route documentation](/api-routes/core-routes)

## Public
[Public route documentation](/api-routes/public-routes)
- [GET /api/external/links](/api-routes/public-routes#get-apiexternallinks)